...
export const aboutUs = [
  {
    title: 'Vision',
    description: 'Drive global change by crafting innovative products and services that elevate everyday living.',
  },
  {
    title: 'Mission',
    description: 'Transform lives by delivering exceptional experiences through the seamless fusion of passion, creativity, and cutting-edge technology.',
  },
  {
    title: 'Values',
    description: 'Integrity, Courage, Commitment, Innovation, and Social Responsibility.',
  },
];
...
export const features = [
  {
    title: 'Vision',
    img: 'https://images.squarespace-cdn.com/content/v1/622f5e28bf38773790814094/e832650b-e8b7-498c-b3b1-b1e7abb7c87a/shutterstock_1908320908.jpg',
    icon: <FaEye />,
    description: 'Drive global change by crafting innovative products and services that elevate everyday living.',
    details: '',
    action: 'Learn More',
  ...
  {
    title: 'Mission',
    img: 'https://img.freepik.com/premium-vector/futuristic-mission-concept-arrow-darts-target-glowing-symbols-text-technology-abstract_726113-365.jpg',
    icon: <FaFlag />,
  ...
  {
    title: 'Values',
    img: 'https://res.cloudinary.com/rubics/image/upload/w_720,h_508,c_fill/f_auto/xcbolpakj2p8pwr2uok1.jpg',
    icon: <FaHeart />,
...
export const ourImpact = [
  { title: 'Empowering Lives', description: 'By developing solutions that solve real-life challenges.' },
  { title: 'Driving Innovation', description: 'Through research and technology integration.' },
  { title: 'Sustainability', description: 'Designing eco-friendly and socially responsible products.' },
  { title: 'Community Engagement', description: 'Partnering with organizations to give back to society.' },
];
...
export const ourVisionForTheFuture = [
  {
    title: 'Our Vision',
    description: 'We envision JOMS as a leading name in consumer innovation, recognized for creating meaningful change. Our future roadmap includes expanding into global markets, partnering with like-minded organizations to amplify social impact, and investing in cutting-edge technologies to enhance our offerings.',
  },
];
